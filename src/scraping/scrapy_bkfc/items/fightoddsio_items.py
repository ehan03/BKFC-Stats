...
class FightOddsIOEventItem(Item):
    id = Field()
    pk = Field()
    slug = Field()
    name = Field()
...
class FightOddsIOSportsbookItem(Item):
    id = Field()
    slug = Field()
    short_name = Field()
    full_name = Field()
...
class FightOddsIOMoneylineOddsSummaryItem(Item):
    id = Field()
    bout_id = Field()
    sportsbook_id = Field()
    outcome_1_id = Field()
...
class FightOddsIOExpectedOutcomeSummaryItem(Item):
    bout_id = Field()
    offer_type_id = Field()
    is_not = Field()
    average_odds = Field()
